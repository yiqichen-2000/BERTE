...
parser.add_argument('path', help='Path to the directory containing .pkl files.')
parser.add_argument('rank', help='The selected rank name (i.e. parent node).')
...
sequence_superfamily = f'{path}/demo_SINE_510bp_superfamliy.pkl'

# Load BERT embedding features for different k-mer lengths
cls_4mer = f'{path}/demo_SINE_506bp_bothend_kmer_fragments.jsonl_cls_embedding_features.pkl'
cls_5mer = f'{path}/demo_SINE_508bp_bothend_kmer_fragments.jsonl_cls_embedding_features.pkl'
cls_6mer = f'{path}/demo_SINE_510bp_bothend_kmer_fragments.jsonl_cls_embedding_features.pkl'
...
count_4mer = f'{path}/demo_SINE_506bp_full_length_kmer_counts_list.pkl'
count_5mer = f'{path}/demo_SINE_508bp_full_length_kmer_counts_list.pkl'
count_6mer = f'{path}/demo_SINE_510bp_full_length_kmer_counts_list.pkl'
